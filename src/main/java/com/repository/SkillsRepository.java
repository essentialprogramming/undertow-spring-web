...
public class SkillsRepository {
    ...
    private static final Skill skill1 = new Skill(
            "68428a4a-b992-42ac-afe2-2a3e11c54bef",
            "teamwork"
    );

    private static final Skill skill2 = new Skill(
            "fdcd63fb-ef7a-4d73-86b4-2571bb15f3a",
            "creativity"
    );

    private static final Skill skill3 = new Skill(
            "3af71f10-d992-457a-847e-b3b6f1b14c5e",
            "communication"
    );

    private static final Skill skill4 = new Skill(
